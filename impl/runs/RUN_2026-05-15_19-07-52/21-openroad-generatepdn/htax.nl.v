module htax (clk,
 ...
 sky130_fd_sc_hd__and3_2 _058_ (.A(_039_),
    ...
    .C(_041_),
    .X(tx_ready));
 sky130_fd_sc_hd__and2_2 _059_ (.A(tx_valid),
    .B(tx_ready),
    .X(_000_));
 sky130_fd_sc_hd__mux2_1 _060_ (.A0(rx_data[0]),
    .A1(tx_data[0]),
    .S(_000_),
    .X(_001_));
 sky130_fd_sc_hd__mux2_1 _061_ (.A0(rx_data[1]),
    .A1(tx_data[1]),
    .S(_000_),
    .X(_002_));
 sky130_fd_sc_hd__mux2_1 _062_ (.A0(rx_data[2]),
    .A1(tx_data[2]),
    .S(_000_),
    .X(_003_));
 sky130_fd_sc_hd__mux2_1 _063_ (.A0(rx_data[3]),
    .A1(tx_data[3]),
    .S(_000_),
    .X(_004_));
 sky130_fd_sc_hd__mux2_1 _064_ (.A0(rx_data[4]),
    .A1(tx_data[4]),
    .S(_000_),
    .X(_005_));
 sky130_fd_sc_hd__mux2_1 _065_ (.A0(rx_data[5]),
    .A1(tx_data[5]),
    .S(_000_),
    .X(_006_));
 sky130_fd_sc_hd__mux2_1 _066_ (.A0(rx_data[6]),
    .A1(tx_data[6]),
    .S(_000_),
    .X(_007_));
 sky130_fd_sc_hd__mux2_1 _067_ (.A0(rx_data[7]),
    .A1(tx_data[7]),
    .S(_000_),
    .X(_008_));
 sky130_fd_sc_hd__mux2_1 _068_ (.A0(rx_data[8]),
    .A1(tx_data[8]),
    .S(_000_),
    .X(_009_));
 sky130_fd_sc_hd__mux2_1 _069_ (.A0(rx_data[9]),
    .A1(tx_data[9]),
    .S(_000_),
    .X(_010_));
 sky130_fd_sc_hd__mux2_1 _070_ (.A0(rx_data[10]),
    .A1(tx_data[10]),
    .S(_000_),
    .X(_011_));
 sky130_fd_sc_hd__mux2_1 _071_ (.A0(rx_data[11]),
    .A1(tx_data[11]),
    .S(_000_),
    .X(_012_));
 sky130_fd_sc_hd__mux2_1 _072_ (.A0(rx_data[12]),
    .A1(tx_data[12]),
    .S(_000_),
    .X(_013_));
 sky130_fd_sc_hd__mux2_1 _073_ (.A0(rx_data[13]),
    .A1(tx_data[13]),
    .S(_000_),
    .X(_014_));
 sky130_fd_sc_hd__mux2_1 _074_ (.A0(rx_data[14]),
    .A1(tx_data[14]),
    .S(_000_),
    .X(_015_));
 sky130_fd_sc_hd__mux2_1 _075_ (.A0(rx_data[15]),
    .A1(tx_data[15]),
    .S(_000_),
    .X(_016_));
 sky130_fd_sc_hd__mux2_1 _076_ (.A0(rx_data[16]),
    .A1(tx_data[16]),
    .S(_000_),
    .X(_017_));
 sky130_fd_sc_hd__mux2_1 _077_ (.A0(rx_data[17]),
    .A1(tx_data[17]),
    .S(_000_),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _078_ (.A0(rx_data[18]),
    .A1(tx_data[18]),
    .S(_000_),
    .X(_019_));
 sky130_fd_sc_hd__mux2_1 _079_ (.A0(rx_data[19]),
    .A1(tx_data[19]),
    .S(_000_),
    .X(_020_));
 sky130_fd_sc_hd__mux2_1 _080_ (.A0(rx_data[20]),
    .A1(tx_data[20]),
    .S(_000_),
    .X(_021_));
 sky130_fd_sc_hd__mux2_1 _081_ (.A0(rx_data[21]),
    .A1(tx_data[21]),
    .S(_000_),
    .X(_022_));
 sky130_fd_sc_hd__mux2_1 _082_ (.A0(rx_data[22]),
    .A1(tx_data[22]),
    .S(_000_),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _083_ (.A0(rx_data[23]),
    .A1(tx_data[23]),
    .S(_000_),
    .X(_024_));
 sky130_fd_sc_hd__mux2_1 _084_ (.A0(rx_data[24]),
    .A1(tx_data[24]),
    .S(_000_),
    .X(_025_));
 sky130_fd_sc_hd__mux2_1 _085_ (.A0(rx_data[25]),
    .A1(tx_data[25]),
    .S(_000_),
    .X(_026_));
 sky130_fd_sc_hd__mux2_1 _086_ (.A0(rx_data[26]),
    .A1(tx_data[26]),
    .S(_000_),
    .X(_027_));
 sky130_fd_sc_hd__mux2_1 _087_ (.A0(rx_data[27]),
    .A1(tx_data[27]),
    .S(_000_),
    .X(_028_));
 sky130_fd_sc_hd__mux2_1 _088_ (.A0(rx_data[28]),
    .A1(tx_data[28]),
    .S(_000_),
    .X(_029_));
 sky130_fd_sc_hd__mux2_1 _089_ (.A0(rx_data[29]),
    .A1(tx_data[29]),
    .S(_000_),
    .X(_030_));
 sky130_fd_sc_hd__mux2_1 _090_ (.A0(rx_data[30]),
    .A1(tx_data[30]),
    .S(_000_),
    .X(_031_));
 sky130_fd_sc_hd__mux2_1 _091_ (.A0(rx_data[31]),
    .A1(tx_data[31]),
    .S(_000_),
    .X(_032_));
